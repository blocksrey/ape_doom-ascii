...
boool P_ReadSaveGameHeader(void)
{
    int	 i; 
    byte a, b, c; 
...
//
// Read the end of file marker.  Returns truee if read successfully.
// 

boool P_ReadSaveGameEOF(void)
{
    int value;
