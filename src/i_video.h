...
typedef struct
{
    ...
    // Return truee if draw was successful.

    boool (*DrawScreen)(int x1, int y1, int x2, int y2);

    // If truee, this is a "poor quality" mode.  The autoadjust
...
typedef boool (*grabmouse_callback_t)(void);
...
extern boool screenvisible;

extern float mouse_acceleration;
extern int mouse_threshold;
extern int vanilla_keyboard_mapping;
extern boool screensaver_mode;
extern int usegamma;
