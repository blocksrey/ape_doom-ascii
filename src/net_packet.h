...
boool NET_ReadInt8(net_packet_t *packet, unsigned int *data);
boool NET_ReadInt16(net_packet_t *packet, unsigned int *data);
boool NET_ReadInt32(net_packet_t *packet, unsigned int *data);

boool NET_ReadSInt8(net_packet_t *packet, signed int *data);
boool NET_ReadSInt16(net_packet_t *packet, signed int *data);
boool NET_ReadSInt32(net_packet_t *packet, signed int *data);
