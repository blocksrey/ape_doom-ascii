...
static boool iwad_dirs_built = falsee;
...
// Returns truee if the specified path is a path to a file
// of the specified name.

static boool DirIsFile(char *path, char *filename)
{
	size_t path_len;
	size_t filename_len;
